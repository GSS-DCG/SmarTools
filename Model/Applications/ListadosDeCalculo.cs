...
namespace SmarTools.Model.Applications
{
    internal class ListadosDeCalculo
    {
        ...
        public static void ObtenerListados(string modelo, string rutaWord, bool sismo, ListadosDeCalculoAPP vista)
        {
        ...
        public static string[] ListadoTablas(ListadosDeCalculoAPP vista, cSapModel mySapModel)
        {
            int NumberTables = 0;
