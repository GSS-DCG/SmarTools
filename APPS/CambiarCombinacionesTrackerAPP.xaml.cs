...
{
    /// <summary>
    /// Lógica de interacción para CambiarCombinacionesTrackerAPP.xaml
    /// </summary>
    public partial class CambiarCombinacionesTrackerAPP : Window
    {
        public CambiarCombinacionesTrackerAPP()
        {
            InitializeComponent();
        }
        ...
        {
            CambiarCombinacionesTracker.GenerarCombinaciones(this);
        }

        private void btnAplicarCombinaciones_Click(object sender, RoutedEventArgs e)
        {
            CambiarCombinacionesTracker.AplicarCombinaciones(this);
        }
        ...
        private void Normativa_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            var coeficientes = CambiarCombinacionesTracker.Coeficientes(this, seleccion);
