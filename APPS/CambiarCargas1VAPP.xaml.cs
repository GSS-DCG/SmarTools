...
{
    /// <summary>
    /// Lógica de interacción para CambiarCargas1VAPP.xaml
    /// </summary>
    public partial class CambiarCargas1VAPP : Window
    {
        public CambiarCargas1VAPP()
        {
            InitializeComponent();
        }
