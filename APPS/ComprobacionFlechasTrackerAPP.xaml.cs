...
{
    /// <summary>
    /// Lógica de interacción para ComprobacionFlechasTrackerAPP.xaml
    /// </summary>
    public partial class ComprobacionFlechasTrackerAPP : Window
    {
        public ComprobacionFlechasTrackerAPP()
        {
            InitializeComponent();
        }
