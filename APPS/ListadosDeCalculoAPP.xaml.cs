...
{
    /// <summary>
    /// Lógica de interacción para ListadosDeCalculoAPP.xaml
    /// </summary>
    public partial class ListadosDeCalculoAPP : Window
    {
        public ListadosDeCalculoAPP()
        {
            InitializeComponent();
        }
        ...
        {
            ListadosDeCalculo.ObtenerListadosDeCalculo(this);
        }
    }
}
