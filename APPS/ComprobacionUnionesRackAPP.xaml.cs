...
{
    /// <summary>
    /// Lógica de interacción para ComprobacionUnionesRackAPP.xaml
    /// </summary>
    public partial class ComprobacionUnionesRackAPP : Window
    {
        public ComprobacionUnionesRackAPP()
        {
            InitializeComponent();
        }
        ...
        {
            ComprobacionUnionesRack.ComprobarUniones(this);
        }
