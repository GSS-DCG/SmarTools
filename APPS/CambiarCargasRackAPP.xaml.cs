...
{
    /// <summary>
    /// Lógica de interacción para CambiarCargasRack.xaml
    /// </summary>
    public partial class CambiarCargasRackAPP : Window
    {
        public CambiarCargasRackAPP()
        {
            InitializeComponent();
        }
        ...
        {
            CambiarCargasRack.AsignarCargas(this);
        }

        private void btnCargarDatos_Click(object sender, RoutedEventArgs e)
        {
            CambiarCargasRack.CargarDatos(this);
        }
    }
}
